...
- Configured the PyPI publish workflow to use the explicit GitHub environment `pypi` for Trusted Publishing compatibility.
- Prepared a fresh release tag after the previous Trusted Publishing mismatch on `v0.1.1`.
